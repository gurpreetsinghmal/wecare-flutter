                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: getinputstyle(hint: "Enter Patient Name"),
                      ...
                      TextFormField(
                        ...
                        decoration: getinputstyle(hint: "Enter Husband Name"),
                        validator: (v) {
                          if (v == null || v.isEmpty) {
                      ...
                      DropdownButtonFormField(
                        ...
                        items: villagedata.map((item) {
                          return DropdownMenuItem(
                            ...
                            child: Text(item["village"]["name"].toString()),
                          );
                        }).toList(),
                        onChanged: (newVal) {
                          setState(() {
                      ...
                      TextFormField(
                        ...
                        decoration:
                            getinputstyle(hint: "Enter Patient Mobile No"),
                        validator: (v) {
                      ...
                      Text("Want to fill information about previous delivery"),
                      DropdownButtonFormField(
                        decoration: getinputstyle(hint: "Previous Delivery"),
                        hint: Text("Select"),
                                        ...
                                        return AlertDialog(
                                          ...
                                          content: Column(
                                              ...
                                              children: [
                                                ...
                                                Text("Age of Previous Child"),
                                                TextFormField(
                                                  controller: prevageController,
                                                  maxLength: 2,
                                                  inputFormatters: <TextInputFormatter>[
                                                    FilteringTextInputFormatter
                                                        .allow(
